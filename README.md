...
Aqui estão alguns dos projetos que mais me orgulho ou que demonstram minhas habilidades:

#### 🍽️ **GestãoGrill - Sistema de Gestão para Restaurantes**
*   **Descrição:** Uma plataforma SaaS completa para otimizar a gestão operacional de restaurantes, bares e churrascarias, centralizando pedidos, mesas, cozinha, cardápio digital e administração.
*   **Tecnologias:** Node.js, Express.js, Socket.IO, MySQL, HTML5, CSS3, JavaScript, Bootstrap, Docker.
